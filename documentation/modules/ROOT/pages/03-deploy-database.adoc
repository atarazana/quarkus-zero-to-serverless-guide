...
quarkus.datasource.jdbc.url = jdbc:postgresql://my-database.user1-fruit-service:5432/my_data
...
You can use the `web-%USER%` shortcut from your CodeReady tool panel (right side) to open the app link
