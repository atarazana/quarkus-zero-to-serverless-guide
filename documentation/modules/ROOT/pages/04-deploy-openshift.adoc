...
[INFO] --------------------------------[ jar ]---------------------------------
[INFO] 
[INFO] --- quarkus-maven-plugin:1.9.2.Final:remove-extension (default-cli) @ atomic-fruit-service ---
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
[INFO] Total time:  1.109 s
[INFO] Finished at: 2021-03-31T18:33:16Z
[INFO] ------------------------------------------------------------------------
----
...
[source,sh,role="copypaste"]
----
mkdir -p $CHE_PROJECTS_ROOT/quarkus-zero-to-serverless-guide/atomic-fruit-service/src/main/kubernetes && \
cat <<EOF > $CHE_PROJECTS_ROOT/quarkus-zero-to-serverless-guide/atomic-fruit-service/src/main/kubernetes/openshift.yml
---
apiVersion: v1
kind: Secret
metadata:
...
You can check the generated file `$CHE_PROJECTS_ROOT/quarkus-zero-to-serverless-guide/atomic-fruit-service/target/kubernetes/openshift.yml`, there you\'ll find: Service and Deployment...
...
----
$ oc apply -n {project_name} -f $CHE_PROJECTS_ROOT/quarkus-zero-to-serverless-guide/atomic-fruit-service/target/kubernetes/openshift.yml
----
====
...
In order to deploy our app to OpenShift as a Knative service... Let\'s add a new target platform !!!
[source,properties,role="copypaste"]
----
